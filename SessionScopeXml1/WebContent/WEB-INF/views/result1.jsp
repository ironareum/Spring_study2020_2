...
<body>
	<h1>result1</h1>
	<h3>//session</h3>
	sessionBean1.data1 : ${sessionScope.sessionBean1.data1 } <br />
	sessionBean1.data2 : ${sessionScope.sessionBean1.data2 } <br />
	<br />
	sessionBean2.data3 : ${sessionScope.sessionBean2.data3 } <br />
	sessionBean2.data4 : ${sessionScope.sessionBean2.data4 } <br />
	<br />
	sessionBean3.data5 : ${sessionScope.sessionBean3.data5 } <br />
	sessionBean3.data6 : ${sessionScope.sessionBean3.data6 } <br />
	<br />
